          ...
          <div className="px-[14px] pb-3">
            <div>
              ...
              <div className="flex gap-2">
                <button className="px-[14px] py-[6px] rounded-[var(--radius-sm)] text-[12px] font-medium bg-error text-white hover:bg-[#D63D39] transition-all duration-150">
                  {data.confirmLabel}
                </button>
                <button className="px-[14px] py-[6px] rounded-[var(--radius-sm)] text-[12px] font-medium bg-bg-sub text-text-secondary hover:bg-bg-hover transition-all duration-150">
                  {data.cancelLabel}
                </button>
              </div>
            </div>
